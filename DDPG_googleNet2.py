...
class Actor1(nn.Module):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.features = torch.nn.Sequential(
            ...
            #torch.nn.MaxPool1d(3, 2, padding=1)
            #Inceptopnv2(in_channels=256,ch1=64,ch3_reduce=48,ch3=64,ch5_reduce=64,ch5=96,pool_pro=32),
            #in_channels=256,ch1=64,ch3_reduce=48,ch3=64,ch5_reduce=64,ch5=96,pool_pro=32
            torch.nn.MaxPool1d(5, 3),
            torch.nn.Conv1d(256, 256, kernel_size=1, stride=1),
        )
    ...
    def forward(self, x):
        ...
        x = self.features(x)
        #print(x.shape)
        x = self.Linear_action(x.view(x.shape[0],256))
        x = self.max_action * x
        return x
...
path_xls = 'motor0on0415_test_true30.xlsx'
    ...
    for i_episode in range(1):  # 300
        ...
        while (1):
            ...
            if num == args.episode_length:  # 300
                ...
                datalist = {"acc1__": acc1__,"acc1c__":acc1c__,"acc2__":acc2__,"acc2c__":acc2c__,"acc3__":acc3__,"acc3c__":acc3c__,"acc4__":acc4__,"acc4c__":acc4c__}
                frame1 = pd.DataFrame(datalist)

                writer = pd.ExcelWriter('datalist.xlsx')
                frame1.to_excel(writer, sheet_name='Sheet1', index=False)
